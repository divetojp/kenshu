...
| アルゴリズム | 長所 | 短所 |
|---|---|---|
| **PC** | 仮定が少ない（線形・非線形どちらでも可）| 矢印方向を完全に決定できない場合がある（等価クラス）|
| **LiNGAM** | 方向を完全に決定できる | 線形性・非ガウス性の仮定が必要 |
| **NOTEARS** | スケーラブル（変数が多くても使える）| 局所最適に陥ることがある |

!!! warning "共通の注意点"
    因果探索の結果はあくまで仮説であり、ドメイン知識による確認が必須です。サンプルサイズが小さいと推定が不安定になり、測定できない交絡因子は検出できません。
---
